...
public class LinkedListActivity extends AppCompatActivity {
    ...
    private static final String TAG ="Linked_list Activity" ;
    ...
    private final String ds = "linkedList";
    ...
    public void insertHandler(View view) {
        setSpinnerData(R.array.insertion_choice_list);
    ...
    public void sortHandler(View view) {
        setSpinnerData(R.array.sort_linked_list_choice);
        setTextColor(sortTv);
    ...
    public void searchHandler(View view) {
        setSpinnerData(R.array.search_linked_list_choice);
