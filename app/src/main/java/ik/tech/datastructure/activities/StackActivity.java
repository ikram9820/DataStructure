...
public class StackActivity extends AppCompatActivity {
    ...
    private static final String TAG ="stack Activity" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insertTv = (TextView) findViewById(R.id.pushTv);
        deleteTv = (TextView) findViewById(R.id.deleteTv);
        frontTv = (TextView) findViewById(R.id.peakTv);
    ...
    public void pushHandler(View view) {
        ...
        setTextColor(insertTv,"push");
    }//end insertHandler

    public void popHandler(View view) {

        setTextColor(deleteTv,"pop");

    }//end deleteHandler

    public void peakHandler(View view) {

        setTextColor(frontTv,"peak");
        ...
        try {
            ...
            code.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    ...
                    Toast.makeText(StackActivity.this, "no such code exist " + error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        ...
        try {
            ...
            codes.child(codeId).setValue(codeModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(StackActivity.this, "value is not set to database", Toast.LENGTH_SHORT);
