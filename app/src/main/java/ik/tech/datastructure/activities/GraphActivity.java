...
public class GraphActivity extends AppCompatActivity {
    ...
    private TextView codeTv, insertTv, deleteTv, algoTv, cppTv, javaTv, pythonTv;
        ...
        try {
            spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onNothingSelected(AdapterView<?> parent) {
                    Toast.makeText(GraphActivity.this, "nothing is selected", Toast.LENGTH_SHORT).show();
                }
            });
        } catch (Exception e) {
    ...
    public void insertHandler(View view) {
        setSpinnerData(R.array.insertion_choice_graph);
        setTextColor(insertTv);
    }//end insertHandler

    public void deleteHandler(View view) {
        setSpinnerData(R.array.deletion_choice_graph);
        ...
        try {
            ...
            code.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    ...
                    Toast.makeText(GraphActivity.this, "no such code exist " + error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        } catch (Exception e) {
        ...
        try {
            ...
            codes.child(codeId).setValue(codeModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(GraphActivity.this, "value is not set to database", Toast.LENGTH_SHORT);
                    Log.e(TAG, e.getMessage());
                }
            });
        } catch (Exception e) {
